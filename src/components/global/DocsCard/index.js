...
function DocsCard(props) {
  ...
  if (isStatic) {
    return (
      <docs-card class={className}>
        <div className={clsx('card', 'docs-card')}>{content}</div>
      </docs-card>
    );
  }
  ...
  if (isOutbound) {
    return (
      <docs-card class={className}>
        <a className={clsx('card', 'docs-card')} href={props.href} target="_blank">
          {content}
        </a>
      </docs-card>
    );
  ...
  return (
    <docs-card class={className}>
      <Link to={props.href} className={clsx('card', 'docs-card')}>
        {content}
      </Link>
    </docs-card>
  );
